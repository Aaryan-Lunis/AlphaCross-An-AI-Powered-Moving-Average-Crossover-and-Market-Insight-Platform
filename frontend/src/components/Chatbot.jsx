...
const Chatbot = ({ symbol, predictionContext, apiBase }) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed right-6 w-96 max-w-[calc(100vw-3rem)] bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 flex flex-col z-50 animate-slide-up"
          style={{
            top: 'max(88px, env(safe-area-inset-top, 0px) + 88px)',
            bottom: '96px',
            maxHeight: '640px'
          }}
        >
          ...
          {/* Messages */}
          <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4 bg-gray-900/30 custom-scrollbar">
            {messages.length === 0 ? (
          ...
          {/* Input */}
          <div className="p-4 border-t border-gray-700 bg-gray-800 flex-shrink-0 rounded-b-2xl">
